odoo.define("website_sale_coupon.coupon", function (require) {
    ...
    templates.done(function () {
        ajax.jsonRpc("/website_sale_coupon/reserved_coupons", "call").done(function (
            result
        ) {
    ...
    $(function () {
        // Wait for the form to be inserted in the DOM
        ...
        $form.on("submit", function (ev) {
            ...
            ajax.jsonRpc("/website_sale_coupon/reserve_coupon", "call", {code: code})
