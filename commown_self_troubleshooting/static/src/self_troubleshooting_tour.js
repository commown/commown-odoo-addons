odoo.define("commown_self_troubleshooting.tour_fp2_battery", function(require) {
  ...
  tour.register(
    "commown_self_troubleshooting_need_new_screen_for_crosscall",
    { url : "/my "},
    [
      {
        content: "Go to the screen replacement page with a Crosscall contract",
      ...
      commonSteps.checkInputNamesMatchesUser,
      commonSteps.gotoNextStep,
      ...commonSteps.funcAddMoreInfo("text My screen is broken and the device needs to be replaceds!"),
