odoo.define("commown_self_troubleshooting.test_tours", function (require) {
    "use strict";
    ...
    const humanText = "Contacter un humain";
        ...
        checkInputNamesMatchesUser: {
            ...
            run: function () {
                ...
                if (this.$anchor.val() !== user) {
                    ...
                    console.log(
                        "Got: '" + this.$anchor.val() + "' instead of '" + user + "'."
                    );
        ...
        [
            ...
            },
            {
                ...
                run: function () {
                    if (!this.$anchor.val()) {
                        console.log(
                            "A contract should have been automatically selected!"
                        );
                        console.log("Error (see above)");
                    }
                },
    ...
    tour.register(
        ...
        [
            ...
            commonSteps.checkInputNamesMatchesUser,
            commonSteps.gotoNextStep,
            ...commonSteps.funcAddMoreInfo(
                "text My screen protection need to be replaced!"
            ),
    ...
    tour.register(
        ...
        [
            ...
            commonSteps.gotoNextStep,
            ...commonSteps.funcAddMoreInfo(
                "text My screen is broken and the device needs to be replaced!"
            ),
    ...
    tour.register(
        ...
        [
            {
                content:
                    "Go to the screen replacement page for a non-repairable phone (ie. Crosscall here)",
    ...
    tour.register("commown_self_troubleshooting_need_new_fairphone", {url: "/my"}, [
        {
    ...
    tour.register("commown_self_troubleshooting_tour_theft_and_loss", {url: "/my"}, [
        {
    ...
    tour.register("commown_self_troubleshooting_tour_gs_day_audio", {url: "/my"}, [
        {
    ...
    tour.register("commown_self_troubleshooting_commercial_request", {url: "/my"}, [
        {
