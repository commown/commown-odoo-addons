...
class ResPartnerSmsTC(SavepointCase):
    ...
    def test_get_mobile_phone(self):
        ...
        partner.update({"phone": "06 23 23.23.23"})
        self.assertEqual(partner.get_mobile_phone(), "0623232323")

        partner.update({"mobile": " +337 33 22 11 00"})
        self.assertEqual(partner.get_mobile_phone(), "0733221100")
        ...
        partner.update({"mobile": "07 33 22 11 00"})
        self.assertFalse(partner.get_mobile_phone())
